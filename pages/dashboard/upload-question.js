...
const plans = [
    {
        name: 'آکادمی مهندسی',
        desc: 'ثبت سوال - بارگذاری مقاله - ثبت ایده و تجربه - ثبت سوال - بارگذاری فایل',
    },
    {
        name: 'کالا و تجهیزات',
        ...
        <Header title={'ایجاد و بارگذاری - مگاوات'}>
            ...
            <div className='lg:pt-32 lg:px-52 pt-20 pb-40 z-40 w-full'>
                <div className="mx-auto lg:px-0 px-6 transition-all duration-200 ease-in-out">
                    <Breadcrumb data={[
                        ['داشبورد', '/dashboard'],
                        ['ثبت سوال', Data.link.upload.question]
                    ]} />
                    <div className='lg:text-[45px] text-2xl -z-40 lg:py-8 py-4 text-gray-900 dark:text-textdark'>
                        <p className='sans-bolisher lg:text-[45px] text-2xl'>ثبت سوال</p>
                    </div>
                    <div className={`pt-5 mt-5 border-t border-gray-300 pb-12`}>
                        ...
                        <div className="flex items-center mt-4">
                            <Check title={'را خوانده ام و موارد مربوطه را میپذیرم'} titlelink={'قوانین بارگذاری فایل'} />
                        </div>
